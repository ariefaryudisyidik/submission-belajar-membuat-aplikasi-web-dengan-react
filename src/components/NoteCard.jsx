  ...
  return (
    <div className="card rounded">
      ...
      <div className="button">
        <button
          onClick={note.archieved ? moveToNotesHandler : archieveHandler}
          className="archieve rounded"
        >
          {note.archieved ? 'Pindahkan' : 'Arsipkan'}
        </button>
        <button onClick={clickHandler} className="delete rounded">
          Hapus
        </button>
      </div>
    </div>
